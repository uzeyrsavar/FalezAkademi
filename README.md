...
- Responsive, sade, profesyonel UI (inline style yerine merkezi CSS sınıfları).
...
## Sürüm ve Güvenlik Notu
- Next.js ve lint toolchain sürümleri güvenlik/güncellik odağıyla yükseltildi.
- Demo veri katmanı korunurken API + veritabanı geçişi için mevcut yapı sürdürüldü.
